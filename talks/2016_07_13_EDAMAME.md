...
**AltMetrics:**
* 3030 mailing list recipients
* 317 wiki articles
* 1648 forum members
* 11935 forum posts for 3188 topics
...
* uses out of date, poorly written code (their mothur is 2+ yrs old)
* is very black boxy
...
* Developing a new algorithm that produces significantly better clusters than AN, is faster, and uses less RAM.
